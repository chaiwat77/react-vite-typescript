...
import { Navigate, NavLink, Outlet, useLoaderData, useLocation, useNavigate } from 'react-router-dom';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  return (
    <Box
      ...
      {LinkItems.map((link) => (
        // custom css by class active by global.css
          ...
          <Menu>
            ...
            <MenuList
              ...
              <MenuItem>Profile</MenuItem>
              {
                ...
                user.role === 'admin' && <MenuItem>Settings for admin</MenuItem>
              }
